...
public class AlbumManagerImpl implements AlbumManager {
    ...
    @Override
    public Optional<AlbumManifest> addPhoto(PhotoMetaDataV1 photoMetaData) {
        ...
        Optional<PhotoMetaDataV1> photoMetaDataInAlbum = albumManifest.getPhotoByFilename(photoMetaData.getFilename());
        if (photoMetaDataInAlbum.isPresent()) {
            ...
            if (md5Hash.equals(existingMd5Hash)) {
                ...
                PhotoMetaDataV1 oldPhotoMetaData = photoMetaDataInAlbum.get();
    ...
    @Override
    public Optional<AlbumManifest> movePhoto(PhotoMetaDataV1 photoMetaData) {
