...
@Data
@Slf4j
public class PhotoMetaDataV1 {
    @JsonCreator
    public PhotoMetaDataV1(@JsonProperty("path") Path path, @JsonProperty("filename") Path filename) {
        this.path = path;
        this.filename = filename;
    }

    public PhotoMetaDataV1(Path path) {
    ...
    public boolean equals(Object o) {
        ...
        PhotoMetaDataV1 that = (PhotoMetaDataV1) o;
